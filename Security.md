...
Responsável: Gabriel Alves

## Introdução
Este relatório apresenta o processo de implementação de ferramentas na empresa Abstergo Industries, realizado por Gabriel Alves. O objetivo do projeto foi elencar 3 medidas de segurança em conjunto dos serviços da AWS, com a finalidade de realizar aumentar a segurança na empresa.
...
Medida 3: 
- O Amazon Inspector será utilizado para ajudar a melhorar a segurança e a conformidade das aplicações executando avaliação de segurança automatizadas.
